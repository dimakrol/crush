...
//
// Domain invariants live HERE, not only in the services: enums for the state
// machines and CHECK constraints for the value ranges. A bug that would write an
// impossible row fails loudly at the write instead of quietly corrupting the
// ledger.
